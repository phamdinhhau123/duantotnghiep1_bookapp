...
public class AdapterContent extends RecyclerView.Adapter<AdapterContent.MyMangaViewHolder> {
    private List<Link> linkList;
    public AdapterContent(List<Link> linkList) {
    ...
    public MyMangaViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AdapterContent.MyMangaViewHolder(itemView);
    }
